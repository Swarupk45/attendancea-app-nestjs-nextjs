...
const Profile = () => {
  ...
  console.log("token from profile",id)
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      console.log("res from profile bbbbbbbbbbbbb", response);
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">{user?.role
    ? typeof user.role === "object" && "roleName" in user.role
      ? user.role.roleName
      : user.role
    : "N/A"}</p>
